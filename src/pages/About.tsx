      ...
      <section className="py-20 md:py-28">
        <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
            {[
              {
                title: "Turning ambition into opportunity",
                description:
                  "Talent is everywhere. Opportunity isn't. We're here to help bridge that gap and make career progression more accessible.",
              },
              {
                title: "Designed around your future",
                description:
                  "Every part of our finance solution is built to support your journey from training to employment, so you can stay focused on building the career you want.",
              },
              {
                title: "Investing in potential",
                description:
                  "We believe capability should determine your future, not your current circumstances. That's why we're committed to helping more Australian residents take the next step.",
              },
              {
                title: "Support you can count on",
                description:
                  "Behind every application is a team that genuinely cares about your success, providing guidance, answers, and support when you need it most.",
              },
              {
                title: "Outcomes that matter",
                description:
                  "Our goal isn't simply to provide finance. It's to help create pathways into meaningful careers, lasting opportunities, and brighter futures.",
              },
            ].map((v) => (
              <div key={v.title} className={v.title === "Outcomes that matter" ? "md:col-span-2 md:max-w-xl" : ""}>
