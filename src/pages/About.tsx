        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-foreground mb-8 tracking-tight leading-[1.05]">
              Financing work experience training.
            </h1>
            <p className="text-xl md:text-2xl text-gray-500 leading-relaxed max-w-3xl">
              The Squad Institute Finance exists for one reason: to make sure money isn't what stops you from starting your work experience training.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 bg-gray-50">
        <div className="container mx-auto px-6 md:px-12">
          <div className="max-w-3xl mx-auto space-y-8 text-lg md:text-xl text-foreground leading-relaxed">
            ...
            <p>So we built a simple plan to finance your work experience training — designed around the program, with real people behind it.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
            {[
              ...
              { title: "Built around the outcome", description: "Designed to fund your training directly — so you can focus on the work." },
