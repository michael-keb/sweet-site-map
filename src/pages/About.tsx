      ...
      <section className="py-20 md:py-28 bg-gray-50">
        <div className="container mx-auto px-6 md:px-12">
          <div className="max-w-3xl mx-auto space-y-8 text-lg md:text-xl text-foreground leading-relaxed">
            ...
            <p>So we built a Buy Now Pay Later product focused on exactly that gap. Fund the program now, between $5,000 and $20,000. Pay it back in fortnightly instalments. 0% interest when you pay on time.</p>
          </div>
        </div>
      </section>
