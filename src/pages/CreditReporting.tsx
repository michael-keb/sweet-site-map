...
const CreditReporting = () => (
  <LegalPage eyebrow="Privacy" title="Credit Reporting Policy">
    <p>This policy explains how we manage credit information and credit eligibility information in connection with our Buy Now Pay Later plans, in accordance with the Privacy Act 1988 (Cth) and the Privacy (Credit Reporting) Code.</p>
    <h2>Information we collect</h2>
    <p>We collect credit information including identification details, the amount and type of plan sought, repayment history on your fortnightly instalments, and any defaults.</p>
    ...
    <h2>Complaints</h2>
    <p>If you believe we've breached our obligations, contact us first. If unresolved, you may lodge a complaint with the Office of the Australian Information Commissioner (OAIC) or AFCA.</p>
  </LegalPage>
);
